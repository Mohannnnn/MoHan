...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = __webpack_require__(173);
	    ...
	    render : function (){
	        ...
	        return (
	            React.createElement("div", null, 
	                React.createElement("h1", {style: style_h1}, "Login"), 
	                React.createElement("p", {style: p}, this.state.pValue), 

	                React.createElement("form", {action: "/loginCheck", method: "post", target: "target"}, 
	                    React.createElement("input", {type: "text", name: "username", className: "username", placeholder: "Username", onFocus: this.focusHandle}), 
	                    React.createElement("input", {type: "password", name: "psw", className: "password", placeholder: "Password", onFocus: this.focusHandle}), 

	                    React.createElement("button", {type: "submit"}, "Sign me in")
	                ), 

	                React.createElement("iframe", {name: "target", onLoad: this.iframeLoad, style: {display:'none'}})
	            )
