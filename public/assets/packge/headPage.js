...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeadPage = __webpack_require__(171);

	ReactDOM.render(
	    React.createElement(HeadPage, null) ,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tabulous = __webpack_require__(172);

	//首页
	var HeadPage = React.createClass({displayName: "HeadPage",
	        ...
	        return (
	            React.createElement("div", null, 
	                React.createElement("div", {id: "header"}, 
	                    ...
	                    React.createElement("h1", null, "Hi ! ", React.createElement("span", null, " MoHan ")), 
	                    React.createElement("h2", null, "致那些年一起陪伴de我们"), 

	                    React.createElement("ul", {id: "mainbuttons"}, 
	                        React.createElement("span", {className: "clear"})
	                    )
	                ), 

	                React.createElement("h3", {className: "demo", id: "demo"}, "导航"), 

	                React.createElement("p", {className: "demointro"}, "大家好，我是MoHan"), 

	                React.createElement("h3", {className: "demo2"}, "鸡汤"), 

	                React.createElement("div", {id: "tabs"}, 
	                    React.createElement("ul", null, 
	                        React.createElement("li", null, React.createElement("a", {href: "#tabs-1", title: ""}, "今天")), 
	                        React.createElement("li", null, React.createElement("a", {href: "#tabs-2", title: ""}, "明天")), 
	                        React.createElement("li", null, React.createElement("a", {href: "#tabs-3", title: ""}, "后天"))
	                    ), 

	                    React.createElement("div", {id: "tabs_container"}, 

	                        React.createElement("div", {id: "tabs-1"}, 
	                            React.createElement("p", null, "牵挂是一杯清茶，飘荡着淡雅的清香，却苦的有味，苦的醇厚，别有一番韵味。牵挂是纯洁，纯真，没有绚丽。牵挂是彼此爱慕的情结，美丽而神秘，让你游动，让你兴奋。")
	                        ), 

	                        React.createElement("div", {id: "tabs-2"}, 
	                            React.createElement("p", null, "别怕，也别怂，感情就是这样，没有失去你不会成熟，生活也是这样，没有遇到点险恶，你不会长大。你想要的，老天不一定会给你，你只有努力去争取， 别辜负爱你的人，别辜负你自己。")

	                        ), 

	                        React.createElement("div", {id: "tabs-3"}, 
	                            React.createElement("p", null, "一份耕耘，一份收获，一份努力，一份成果。你只看到别人辉煌，却看不到辉煌背后掩盖的坚持。你只看到别人风光，却看不到风光背后掩盖的努力。当你享受的时候，别人在奔跑。当你抱怨的时候，别人在醒悟。当你纠结的时候，别人在调整。当你脆弱的时候，别人却把泪咽到肚子里。")
	                        )
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var jQuery = __webpack_require__(170);

	exports.Tabulous = function ( $, window, document, undefined ) {
